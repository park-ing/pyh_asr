...
from .av_dataset import AVDataset, InferDataset
...
class DataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        point_sampler = RandomSampler(train_ds)
        sampler = BatchSampler(point_sampler, self.cfg.data.max_sentences,False)
    ...
    def val_dataloader(self):
        ...
        point_sampler = SequentialSampler(val_ds)
        sampler = BatchSampler(point_sampler, self.cfg.data.max_sentences, True)
        if self.total_gpus > 1:
    ...
    def predict_dataloader(self, lists):
